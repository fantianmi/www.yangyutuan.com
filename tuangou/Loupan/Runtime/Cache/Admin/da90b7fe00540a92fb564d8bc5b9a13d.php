...
var URL = '/Loupan/index.php/Admin/Adboard';
...
<div class="pad-lr-10">
  ...
  <form id="myform" name="myform" action="<?php echo u('Adboard/delete');?>" method="post" onsubmit="return check();">
	...
	function edit(adboard_id, name) {
		...
		window.top.art.dialog({title:lang_edit+'--'+name,id:'edit',iframe:'/Loupan/index.php/Admin/Adboard/edit/id/'+adboard_id,width:'600',height:'300'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
	}
