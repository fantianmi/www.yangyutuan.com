...
<body scroll="no">
<div id="header">
    <div class="logo"><a href="/Loupan/index.php" title="<?php echo (L("website_manage")); ?>"></a></div>
    <div class="fr">
    ...
    <div class="col-auto" style="overflow: visible">
		...
		<div class="log_right white cut_line">
	        <!-- <a href="javascript:;" id="maxtime"><?php echo ($setting['logout_time']); ?></a><a href="javascript:;"> 秒后退出系统</a>	 -->		
    ...
    <div class="right_main">
        <div class="crumbs">
            <div class="shortcut cu-span"> 
				...
				<a href="javascript:void(0);" onclick="$.get('/Loupan/cc.php');alert('缓存清理成功。')" target="right">
...
<pin:load type="js" href="/Loupan/Public/static/js/jquery/plugins/jquery.tools.min.js,/Loupan/Public/static/js/jquery/plugins/jquery.masonry.js,/Loupan/Public/static/js/jquery/plugins/formvalidator.js,/Loupan/Public/static/js/fileuploader.js,/Loupan/Public/static/js/pinphp.js,/Loupan/Public/static/js/front.js,/Loupan/Public/static/js/dialog.js,/Loupan/Public/static/js/wall.js,/Loupan/Public/static/js/item.js,/Loupan/Public/static/js/user.js,/Loupan/Public/static/js/album.js" />
</body>
</html>