...
var URL = '/Loupan/index.php/Admin/User';
...
<div class="pad-10" >
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($k % 2 );++$k;?><tr>
           ...
           <td align="center" onclick="status(<?php echo ($val["id"]); ?>,'status')" id="status_<?php echo ($val["id"]); ?>"><img src="/Loupan/statics/images/status_<?php echo ($val["status"]); ?>.gif" /></td>
...
function status(id,type){
    $.get("<?php echo u('User/status');?>", { id: id, type: type }, function(jsondata){
		...
		$("#"+type+"_"+id+" img").attr('src', '/Loupan/statics/images/status_'+return_data+'.gif')
	}); 
}
</script>
</body>
