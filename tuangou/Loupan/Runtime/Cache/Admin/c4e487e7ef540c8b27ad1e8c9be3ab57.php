...
var URL = '/Loupan/index.php/Admin/Nav';
    ...
    <table width="100%" cellspacing="0">
        <thead>
            <tr>
                ...
                <th width="100"><?php echo L('alias');?></th>
                <th align="left">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo L('url');?></th>
				 <th width="260"><?php echo L('category');?></th>
                <th width="60"><?php echo L('type');?></th>
                <th width="60"><?php echo L('is_show');?></th>
                <th width="60"><?php echo L('in_site');?></th>
    	...
    	<tbody>
        	<?php if(is_array($nav_list)): $i = 0; $__LIST__ = $nav_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
				...
				<td align="center"><?php echo ($val["category"]["name"]); ?></td>
                <td align="center"><?php if($val["type"] == '1'): ?><em class="blue">顶部</em><?php else: ?>底部<?php endif; ?></td>
                <td align="center" onclick="status(<?php echo ($val["id"]); ?>,'is_show')" id="is_show_<?php echo ($val["id"]); ?>"><img src="/Loupan/Public/Admin/images/status_<?php echo ($val["is_show"]); ?>.gif"</td>
...
function edit(id, name) {
	...
	window.top.art.dialog({title:lang_edit+'--'+name,id:'edit',iframe:'/Loupan/index.php/Admin/Nav/edit/id/'+id,width:'540',height:'510'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
