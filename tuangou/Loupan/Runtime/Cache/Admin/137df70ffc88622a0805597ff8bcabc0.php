...
<div class="pad_10">
<form action="<?php echo u('Nav/add');?>" method="post" name="myform" id="myform" >
<table width="100%" cellpadding="2" cellspacing="1" class="table_form">	
	...
	<tr id="tr_url" style="display:none;">
      ...
      <td><?php if($nav['type'] == '0'): echo ($nav["url"]); else: ?><input type="text" name="url" id="url" class="input-text" value="http://" size="35"><?php endif; ?></td>
    </tr>
	<tr>
