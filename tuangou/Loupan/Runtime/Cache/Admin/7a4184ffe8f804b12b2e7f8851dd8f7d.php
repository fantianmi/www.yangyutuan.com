...
var URL = '/Loupan/index.php/Admin/Article';
...
<div class="pad-10" >
    ...
    <table width="100%" cellspacing="0" class="search-form">
        ...
        <input class="date input-text" type="text" name="time_end" id="time_end" size="18" value="<?php echo ($time_end); ?>" />    
                ...
                <?php if(is_array($cate_list)): $i = 0; $__LIST__ = $cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($cate_id == $val['id']): ?>selected="selected"<?php endif; ?>><?php echo ($val["html"]); echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
                &nbsp;关键字 :
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($article_list)): $i = 0; $__LIST__ = $article_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>       
            ...
            <td align="center" onclick="status(<?php echo ($val["id"]); ?>,'is_hot')" id="is_hot_<?php echo ($val["id"]); ?>"><img src="/Loupan/Public/Admin/images/status_<?php echo ($val["is_hot"]); ?>.gif" /></td>
            <td align="center" onclick="status(<?php echo ($val["id"]); ?>,'is_best')" id="is_best_<?php echo ($val["id"]); ?>"><img src="/Loupan/Public/Admin/images/status_<?php echo ($val["is_best"]); ?>.gif" /></td>
