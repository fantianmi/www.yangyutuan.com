...
var URL = '/WhereReadyNews/index.php/Admin/Admin';
...
<div class="pad-lr-10">
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($admin_list)): $i = 0; $__LIST__ = $admin_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center" onclick="statuss(<?php echo ($val["id"]); ?>,'status')" id="status_<?php echo ($val["id"]); ?>"><img src="/WhereReadyNews/Public/Admin/images/status_<?php echo ($val["status"]); ?>.gif" /></td>
...
function edit(id, name) {
	...
	window.top.art.dialog({title:lang_edit+'--'+name,id:'edit',iframe:'/WhereReadyNews/index.php/Admin/Admin/edit/id/'+id,width:'480',height:'250'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
function statuss(id,type){ 
