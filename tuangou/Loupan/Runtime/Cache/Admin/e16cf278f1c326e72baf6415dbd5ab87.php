        ...
        <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
          ...
          <tr>
            ...
            <td><select name="cate_id" id="cate_id" style="width:200px;">
                ...
                <?php if(is_array($cate_list)): $i = 0; $__LIST__ = $cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>"><?php echo ($val["html"]); echo ($val["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select></td>
          </tr>
          <tr>
          ...
          <tr>
           ...
           <tr>
            ...
            <td>            	
				<script type="text/javascript" src="/Loupan/public/js/kindeditor/kindeditor.js"></script><script type="text/javascript" src="/Loupan/public/js/kindeditor/lang/zh_CN.js"></script><script> var editor; KindEditor.ready(function(K) { editor = K.create('#info');});</script><textarea id="info" style="width:70%;height:350px;" name="info" ></textarea>
			</td>
          </tr>
          <tr>
