     ...
     public function _calendar($tag,$content){
        ...
        if($more=='true'){
           $link='';
             ...
             $link='<link rel="stylesheet" type="text/css" href="__ROOT__/public/js/calendar/calendar-blue.css"/>
            <script type="text/javascript" src="__ROOT__/public/js/calendar/calendar.js"></script>';
        }
        $parseStr=''.$link.'
    ...
    public function _editor($tag,$content) {
     ...
     //   $content    =   $tag['content'];
        ...
        switch(strtoupper($type)) {
            ...
            /*自定义的一个类型,用来加载编辑器的*/
            case 'WHERES':                
                $parseStr='<script type="text/javascript" src="__ROOT__/public/js/kindeditor/kindeditor.js"></script><script type="text/javascript" src="__ROOT__/public/js/kindeditor/lang/zh_CN.js"></script><script> var editor; KindEditor.ready(function(K) { editor = K.create(\'#'.$id.'\');});</script><textarea id="'.$id.'" style="'.$style.'" name="'.$name.'" >'.$content.'</textarea>';
                break;
            default :
