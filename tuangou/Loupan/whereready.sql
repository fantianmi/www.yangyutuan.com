...
Source Database       : whereready

Target Server Type    : MYSQL
Target Server Version : 50534
File Encoding         : 65001

Date: 2015-01-01 16:42:26
*/

SET FOREIGN_KEY_CHECKS=0;
-- ----------------------------
-- Table structure for `wr_access`
-- ----------------------------
DROP TABLE IF EXISTS `wr_access`;
...
-- ----------------------------
-- Table structure for `wr_adboard`
-- ----------------------------
DROP TABLE IF EXISTS `wr_adboard`;
...
-- Records of wr_admin
-- ----------------------------
INSERT INTO `wr_admin` VALUES ('1', 'admin', '0192023a7bbd73250516f069df18b500', '1407848436', null, '1', '1');
...
-- ----------------------------
-- Table structure for `wr_admin_log`
-- ----------------------------
DROP TABLE IF EXISTS `wr_admin_log`;
...
-- ----------------------------
-- Table structure for `wr_article`
-- ----------------------------
DROP TABLE IF EXISTS `wr_article`;
...
-- ----------------------------
-- Records of wr_article
-- ----------------------------
INSERT INTO `wr_article` VALUES ('4', '10', 'dasd', 'das', '', 'dasd', 'dasd', 'dasd', '2015-01-01 16:40:12', '0', '1', '0', '1', '', '', '');

-- ----------------------------
-- Table structure for `wr_cate`
-- ----------------------------
DROP TABLE IF EXISTS `wr_cate`;
...
-- ----------------------------
-- Table structure for `wr_flink`
-- ----------------------------
DROP TABLE IF EXISTS `wr_flink`;
...
-- ----------------------------
-- Table structure for `wr_flink_cate`
-- ----------------------------
DROP TABLE IF EXISTS `wr_flink_cate`;
...
-- ----------------------------
-- Records of wr_flink_cate
-- ----------------------------
INSERT INTO `wr_flink_cate` VALUES ('1', '友情链接');
INSERT INTO `wr_flink_cate` VALUES ('2', '合作伙伴');

-- ----------------------------
-- Table structure for `wr_group`
-- ----------------------------
DROP TABLE IF EXISTS `wr_group`;
...
-- ----------------------------
-- Table structure for `wr_nav`
-- ----------------------------
DROP TABLE IF EXISTS `wr_nav`;
CREATE TABLE `wr_nav` (
...
-- ----------------------------
-- Table structure for `wr_node`
-- ----------------------------
DROP TABLE IF EXISTS `wr_node`;
...
INSERT INTO `wr_node` VALUES ('99', 'Flink', '友情链接', '', '', '', '1', '', '4', '0', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('100', 'Flink', '友情链接', 'index', '友情链接列表', '', '1', '', '0', '1', '4', '0', '0');
...
INSERT INTO `wr_node` VALUES ('145', 'Adboard', '广告位置', '', '', '', '1', '', '800', '0', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('146', 'Adboard', '广告位置', 'index', '广告位置', '', '1', '', '0', '1', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('147', 'Adboard', '广告位置', 'add', '添加广告位置', '', '1', '', '0', '2', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('148', 'Adboard', '广告位置', 'edit', '编辑广告位置', '', '1', '', '0', '2', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('149', 'Adboard', '广告位置', 'delete', '删除广告位置', '', '1', '', '0', '2', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('150', 'Ad', '广告管理', '', '', '', '1', '', '3', '0', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('151', 'Ad', '广告管理', 'index', '广告列表', '', '1', '', '799', '1', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('152', 'Ad', '广告位置', 'add', '添加广告', '', '1', '', '0', '2', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('153', 'Ad', '广告位置', 'edit', '编辑广告', '', '1', '', '0', '2', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('154', 'Ad', '广告位置', 'delete', '删除广告', '', '1', '', '0', '2', '4', '0', '0');
INSERT INTO `wr_node` VALUES ('155', 'User', '会员管理', '', '', '', '1', '', '0', '0', '8', '0', '0');
INSERT INTO `wr_node` VALUES ('156', 'User', '会员管理', 'index', '会员列表', '', '1', '', '0', '1', '8', '0', '0');

-- ----------------------------
-- Table structure for `wr_role`
-- ----------------------------
DROP TABLE IF EXISTS `wr_role`;
...
-- ----------------------------
-- Table structure for `wr_setting`
-- ----------------------------
DROP TABLE IF EXISTS `wr_setting`;
