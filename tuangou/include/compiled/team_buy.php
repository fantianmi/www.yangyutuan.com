...
<div id="content">
    ...
    <div id="deal-buy" class="box">
        ...
        <div class="box-content">
			...
			<?php }?>
			<div class="field mobile" style="width:600px;">
				<label>订单附言</label>
				<textarea name="remark" style="width:450px;height:80px;padding:2px;"><?php echo htmlspecialchars($order['remark']); ?></textarea>
			</div>
