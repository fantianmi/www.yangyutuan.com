...
<section class="w-goods " mon="action=click&amp;type=item">
 <a href="order.php?id=<?php echo $one['id']; ?>" mon="query=&amp;page_catg=0&amp;nuomi_order=0&amp;content=item0&amp;dealTinyUrl=swdbwplc&amp;deal_id=964894&amp;nuomi_index=0&amp;pageindex=0" class="clearfix" name="0" id="0">
 ...
 <li class="info">订单号:<?php echo $one['id']; ?></li>
 <li class="others">数量：<?php echo moneyit($one['quantity']); ?> 总价：<?php echo $currency; ?><?php echo moneyit($one['origin']); ?>
 </li>
 </ul>
 </a>
 </section>
