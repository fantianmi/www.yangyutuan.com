                    ...
                    <form method="post">
                        ...
                        <div class="field">
                            ...
                            <input type="text" size="30" name="system[tencentjiwai]" class="f-input f-hint" value="<?php echo htmlspecialchars(stripslashes($INI['system']['tencentjiwai'])); ?>"/>
						      ...
						      <div class="field">
                            <label>客服热线</label>
                            <input type="text" size="30" name="system[kefu_hotline]" class="f-input f-hint" value="<?php echo htmlspecialchars(stripslashes($INI['system']['kefu_hotline'])); ?>"/>
						</div>
                        <div class="field">
                            <label>服务时间</label>
                            <input type="text" size="30" name="system[server_time]" class="f-input f-hint" value="<?php echo htmlspecialchars(stripslashes($INI['system']['server_time'])); ?>"/>
						</div>
                        <div class="field">
                            <label>投诉邮箱</label>
                            <input type="text" size="30" name="system[tousu_email]" class="f-input f-hint" value="<?php echo htmlspecialchars(stripslashes($INI['system']['tousu_email'])); ?>"/>
						</div>
