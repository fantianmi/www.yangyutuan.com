						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="green"><?php echo $INI['system']['abbreviation']; ?></span>
									<span class="black">商户登录</span>
								</h1>
												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" class="form-control" placeholder="用户名" name="username" id="biz-username"  datatype="require" require="true"  />
															<i class="icon-user"></i>
														</span>
													</label>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" name="password" id="biz-password" placeholder="密码" datatype="require" require="true"  />
															<i class="icon-lock"></i>
														</span>
													</label>
