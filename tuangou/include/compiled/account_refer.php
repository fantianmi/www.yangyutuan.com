					...
					<div class="share-list">
						<div class="blk im">
							...
							<div class="info">
								...
								<input id="share-copy-text" type="text" value="<?php echo $INI['system']['wwwprefix']; ?>/r.php?r=<?php echo $mail; ?>" size="80" class="f-input" onfocus="this.select()" tip="复制成功，可以通过 MSN 或 QQ 发送给好友了" />
