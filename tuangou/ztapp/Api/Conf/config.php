...
//缓存配置（注意，缓存只有在关闭了DEBUG模式下才有明显作用，DEBUG模式在Api.php里改）
    ...
    //客服电话
    'SystemHelpPhone'=>'0930-6219932',
    
    //团购合作电话
    'SystemTuanJoinPhone'=>'18093068381',
...
//-------------图片 CDN ------------结束
    ...
    'TuanSearchHotKeys' => '火锅,建材,洗浴,米线,电影,保健,健身',//客户端搜索界面推荐搜索关键字，英文逗号分割
...
//支付宝快捷支付配置
    ...
    'alipay_partner'=>'',//合作伙伴ID ，例如：2088502009793717
    'alipay_seller'=>'',//签约支付宝账号或卖家支付宝帐户，例如：512267226@qq.com
...
//中国银联
    'upmp_mer_id'=>'898111148990702',//商户号
    'upmp_mer_security_key'=>'drERsyvf4flS3DmOK3cMZtIyT1n5rFTk',// 商户密钥
...
//-----------------以下内容为框架配置，如果你不熟千万别动-----------------
    ...
    'APP_AUTOLOAD_PATH' =>'@.Engine,@.Other.Tenpay,@.Other.AliPay,@.Other.UnionPay,@.Other.WeChatPay,@.Other.Upmp',
